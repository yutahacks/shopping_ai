        ...
        {result.status === "completed" && (
          <div className="space-y-3">
            ...
            {result.added_count > 0 && (
              <a
                href="https://www.amazon.co.jp/gp/cart/view.html"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-orange-500 rounded-md hover:bg-orange-600 transition-colors"
              >
                Amazon カートを確認する
